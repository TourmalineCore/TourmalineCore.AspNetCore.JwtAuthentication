using Example.NetCore8._0.RefreshTokenAuthAndRegistrationUsingIdentity.Data;
using Example.NetCore8._0.RefreshTokenAuthAndRegistrationUsingIdentity.Models;
...
builder.Services
    .AddDbContext<AppDbContext>(options =>
        options.UseInMemoryDatabase("TestDb_Net8")
    );
